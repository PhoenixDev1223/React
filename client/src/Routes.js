...
const routesConfig = [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        exact: true,
        path: '/app/management/books',
        component: lazy(() => import('src/views/management/Books/ShowBookList'))
      },
      {
        exact: true,
        path: '/app/management/books/create-book',
        component: lazy(() => import('src/views/management/Books/CreateBook'))
      },
      {
        exact: true,
        path: '/app/management/books/edit-book/:id',
        component: lazy(() => import('src/views/management/Books/UpdateBookInfo'))
      },
      {
        exact: true,
        path: '/app/management/books/show-book/:id',
        component: lazy(() => import('src/views/management/Books/ShowBookDetails'))
      },
      {
        exact: true,
        path: '/app/management/users',
        component: lazy(() => import('src/views/management/Users/Index'))
      },
      {
        exact: true,
        path: '/app/management',
